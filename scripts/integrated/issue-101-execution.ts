    ...
    testSpecs: [
      {
        ...
        testCases: [
          'should run review and display results table',
          'should loop until quality ≥ threshold',
          'should auto-fix ESLint issues when requested',
          'should allow manual override',
        ],
      },
      {
        filePath: 'tests/e2e/review-command.test.ts',
        testType: 'e2e',
        framework: 'vitest',
        expectedBehavior: 'E2E testing of /review command',
        testCases: [
          'should execute review command successfully',
          'should respect --threshold option',
          'should auto-fix with --auto-fix flag',
          'should limit iterations with --max-iterations',
        ],
      },
    ],
    acceptanceCriteria: [
