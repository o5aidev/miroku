...
- Test DeploymentAgent health checks
    ...
    testSpecs: [
      {
        filePath: '.claude/agents.md',
        testType: 'documentation',
        framework: 'markdown',
        expectedBehavior: 'Complete verification guidelines',
        testCases: [
          'Overview section with auto-loop explanation',
          'Verification scripts by category (UI, API, Perf, Security)',
          'Agent-specific workflows (CodeGen, Review, Deploy)',
          'Unique terminology defined (exec verify, exec plan)',
          'Troubleshooting section',
        ],
      },
      {
        filePath: 'tests/e2e/agent-verification.test.ts',
        testType: 'e2e',
        framework: 'vitest',
        expectedBehavior: 'E2E testing of agent verification loops',
        testCases: [
          'CodeGenAgent should iterate until checks pass',
          'ReviewAgent should loop until quality ≥ 80',
          'DeploymentAgent should verify before deploy',
