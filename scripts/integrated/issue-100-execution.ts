...
- Update documentation with examples
    ...
    testSpecs: [
      {
        filePath: 'agents/coordinator/plan-generator.ts',
        testType: 'unit',
        framework: 'vitest',
        expectedBehavior: 'Generate structured Plans.md from DAG',
        testCases: [
          'should convert DAG to markdown structure',
          'should group tasks by dependency level',
          'should track progress accurately',
          'should log decisions with timestamps',
          'should generate timeline information',
        ],
      },
      {
        filePath: 'tests/CoordinatorAgent.test.ts',
        testType: 'integration',
        framework: 'vitest',
        expectedBehavior: 'CoordinatorAgent generates Plans.md',
        testCases: [
          'should generate plans.md on task decomposition',
          'should update plans.md on progress changes',
          'should persist plans.md to worktree directory',
        ],
      },
    ],
    acceptanceCriteria: [
